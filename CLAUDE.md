...
3. **Ikke dikt opp historie.** Bruk kun fakta fra `src/content/`. Mangler noe, skriv `[[TODO: …]]` i teksten. Årstall merket `(verifiser)` i denne filen skal vises i innholdsfilene med kommentaren `<!-- VERIFISER -->`.
...
### 7.1 Utkast til epoker (alle årstall og påstander skal verifiseres av eier)

| # | Slug | År | Tittel | Tema | Stikkord |
|---|---|---|---|---|---|
| 1 | hestesporveien | 1875 | Hestesporveien | lys | Kristiania Sporveisselskab, første linjer med hest (verifiser) |
| 2 | elektrisk-trikk | 1894 | Den elektriske trikken | lys | Kristiania Elektriske Sporvei, tidlig elektrisk sporvei i Norden (verifiser) |
| 3 | forstadsbanene | 1898 | Banene til åsene | lys | Holmenkolbanen og forstadsbanene vestover (verifiser) |
| 4 | oslo-sporveier | 1924 | Byen tar over | lys | Kommunalt eierskap, Oslo Sporveier (verifiser) |
| 5 | forste-tunnel | 1928 | Under byen | lys | Tunnel Majorstuen–Nationaltheatret (verifiser) |
| 6 | etterkrigstid | 1945–1960-tallet | Etterkrigstid og debatten om trikken | lys | Vekst, nedleggelser, planene for T-bane |
| 7 | t-banen | 1966 | T-banen åpner | tunnel | Første T-banestrekning østover (verifiser) |
| 8 | fellestunnelen | 1987–1993 | Øst møter vest | tunnel | Fellestunnelen, sammenkobling øst–vest (verifiser) |
| 9 | ringen | 2006 | Ringen | tunnel → lys | Ringbanen og nytt T-banemateriell (verifiser) |
| 10 | sporveien | 2010-tallet | Sporveien | lys | Organisasjonsendringer, oppgradering av baner (verifiser) |
